...
<section class="section">
  <div class="row">
    ...
    <center><h5 class="card-title">Barangay Health Workers</h5></center>
      ...
      <div class="card">
        <div class="card-body">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Barangay Health Worker</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                                    <div class="modal-body">

                                    <form action="add_bhw.php" method="post">
                                        ...
                                        <div class="form-floating mb-3 col-md-12">
                                            <input type="number" name="cell" class="form-control" id="floatingInput" placeholder="name@example.com">
          ...
          <table class="table datatable">
            ...
            <tbody>
            <?php
                $result = mysqli_query($conn,"select * from bhw_user") or die ("database error:".mysqli_error($conn));
              ...
              <tr>
                ...
                <td><?php echo $cell; ?></td>
                <td><a class="btn btn-primary row-md-3" href="edit_bhw.php?edit=<?php echo $user_ids;?>">Update</a></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
