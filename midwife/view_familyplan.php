                    ...
                    <h5 class="card-title"> </h5>
                                ...
                                <div style="display: flex;" >
                                    ...
                                    <div style="display: flex; margin-right: 20px; margin-top: 5px; margin-left: 75px;">
                                        ...
                                        <div style="display: block; margin-left: 75px; ">
                                            ...
                                            <div class="form-check" style="margin-right: 10px;">
                                                <input class="form-check-input" name="dysmenorrhea" type="checkbox" id="gridCheck1" value=" <?php echo $dysmenorrhea ?>" readonly >
                                                    <label class="form-check-label" for="gridCheck1">
                                                    Dysmenorrhea
                                                    </label>
                                            </div>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="hydatidiform" type="checkbox" id="gridCheck1" value=" <?php echo $hydatidiform ?>" readonly >
                                                    <label class="form-check-label" for="gridCheck1">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="ectopic" type="checkbox" id="gridCheck1" value=" <?php echo $ectopic ?>" readonly >
                                                    <label class="form-check-label" for="gridCheck1">
                                    ...
                                    <div style="display: flex;" >
                                        ...
                                        <div>
                                            ...
                                            <div class="form-check" style="margin-left:150px;">
                                                <input class="form-check-input" name="tenderness" type="checkbox" id="gridCheck1" value=" <?php echo $tenderness ?>" readonly >
                                                    <label class="form-check-label" for="gridCheck1">
                                                    cervical tenderness
                                                    </label>
                                            </div>
                                            ...
                                            <div class="form-check" style="margin-left:150px;">
                                                <input class="form-check-input" name="adnexalmass" type="checkbox" id="gridCheck1" value=" <?php echo $adnexalmass ?>" readonly>
                                                    <label class="form-check-label" for="gridCheck1">
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                        ...
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            ...
                                                            <div class="modal-body">
                                                                    ...
                                                                    <div class="form-floating mb-3 col-md-12">
                                                                        <textarea class="form-control" name="medfindings" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;" required ></textarea>
                                                                        <label for="floatingInput">MEDICAL FINDINGS</label>
                                                                    </div>

                                                                    <div class="form-floating mb-3 col-md-12">
                                                                        <input type="text" name="methaccep" class="form-control" id="floatingInput" placeholder="name@example.com" required >
                                                                        <label for="floatingInput">METHOD ACCEPTED</label>
                                                                    </div>
                                                                    
                                                                    <div class="form-floating mb-3 col-md-12">
                                                                        <input type="text" name="serviceprovider" class="form-control" id="floatingInput" placeholder="name@example.com" required >
                                                                        <label for="floatingInput">NAME AND SIGNATURE OF SERVICE PROVIDER</label>
                                                                    </div>

                                                                    <div class="form-floating mb-3 col-md-12">
                                                                        <input type="date" name="datasp" class="form-control" id="floatingInput" placeholder="name@example.com" required >
                                                                        <label for="floatingInput">DATE OF FOLLOW-UP VISIT</label>
                                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="sabe" class="btn btn-primary">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- End Large Modal-->
                        ...
                        <?php
                                ...
                                if (isset($_POST['sabe'])) {
                                    $id_a = $_POST['id_a'];
                                    $datam = date('Y-m-d');
                                    $medfindings = $_POST['medfindings'];
                                    $methaccep = $_POST['methaccep'];
                                    $serviceprovider = $_POST['serviceprovider'];
                                    $datasp = $_POST['datasp'];

                                    mysqli_query($conn, "INSERT INTO fam_plan (datam, medfindings, methaccep, serviceprovider, datasp, id_a) 
                                                        VALUES ('$datam', '$medfindings', '$methaccep', '$serviceprovider', '$datasp',' $id_a')");
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                    <tr>
                                        <th scope="col"><center>DATE OF VISIT</center></span><br><span style=" font-size: 15px; "><i>(MM/DD/YYYY)</i></span></th>
                                        <th scope="col"><center>Medical Findings</center><br><span style=" font-size: 10px; display:flex; text-align: center; "><i>(Medical observation, complaints/ complication, service rendered/ procedures labaratory examination, treatment and referrals)</i></span></th>
                                        <th scope="col"><center>METHOD ACCEPTED</center></th>
                                        <th scope="col"><center>NAME AND SIGNATURE OF SERVICE PROVIDER</center></th>
                                        <th scope="col"><center>DATE OF FOLLOW-UP VISIT</center><br><span style=" font-size: 10px; display:flex; text-align: center; "><i>(MM/DD/YYYY)</i></span></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    $resultl = mysqli_query($conn,"SELECT * FROM fam_plan WHERE id_a ='$edit_id'") or die ("database error:".mysqli_error($conn));
                                        while($rowl=mysqli_fetch_array($resultl)){
                                            $id_af = $rowl['id_a'];
                                            $datamf = $rowl['datam'];
                                            $medfindingsf = $rowl['medfindings'];
                                            $methaccepff = $rowl['methaccep'];
                                            $serviceproviderf = $rowl['serviceprovider'];
                                            $dataspf = $rowl['datasp'];
                                    ...
                                    <tr>
                                        <th><?php echo $datamf ?></th>
                                        <td><?php echo $medfindingsf ?></td>
                                        <td><?php echo $methaccepff ?></td>
                                        <td><?php echo $serviceproviderf ?></td>
                                        <td><?php echo $dataspf ?></td>
                                    </tr>
                                    <?php } ?>
